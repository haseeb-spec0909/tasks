...
output "jwt_secret_name" {
  ...
  description = "Secret Manager secret name for JWT"
  sensitive   = true
}

output "oauth_secret_name" {
  value       = google_secret_manager_secret.oauth_client_secret.name
  description = "Secret Manager secret name for OAuth"
  sensitive   = true
}

output "projectflow_api_key_name" {
  value       = google_secret_manager_secret.projectflow_api_key.name
  description = "Secret Manager secret name for ProjectFlow API key"
  sensitive   = true
}
